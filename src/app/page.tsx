...
import { trackCTAClick, trackPricingPlanView, trackCTAButtonClick, testGA4Connection } from "@/lib/analytics"
...
export default function HomePage() {
  ...
  const handleContactSalesClick = (location: string, planType?: string) => {
    trackCTAButtonClick('contact_sales', location, planType)
    setShowContactDialog(true)
  }

  const handleStartTrialClick = (location: string, planType?: string) => {
    trackCTAButtonClick('start_trial', location, planType)
    setShowContactDialog(true)
  }

  const handleRequestDemoClick = (location: string, planType?: string) => {
    trackCTAButtonClick('request_demo', location, planType)
    setShowContactDialog(true)
  }
      ...
      <header className="border-b bg-white/80 backdrop-blur-sm sticky top-0 z-50">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <Button
            ...
            onClick={() => trackCTAClick('request_demo', 'Contact Sales', '/header', () => handleContactSalesClick('header'))}
          >
            Contact Sales
          </Button>
        </div>
          ...
          <Card className="border-2 border-blue-200 shadow-xl relative">
            ...
            <CardContent className="space-y-4">
              ...
              <Button
                ...
                data-ga-id="request_demo"
                className="w-full mt-6"
                onClick={() => trackCTAClick('request_demo', 'Contact Sales', '/pricing-enterprise', () => handlePricingPlanClick('enterprise'))}
              >
                Contact Sales
              </Button>
            </CardContent>
