    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
      ...
      <section className="container mx-auto px-4 pt-20 pb-16 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Button size="lg" onClick={() => setShowContactDialog(true)} className="text-lg px-8">
            Start Free Trial
        ...
        <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-8">
          <Card className="border-0 shadow-lg">
            ...
            <CardContent className="space-y-4">
              ...
              <Button className="w-full mt-6" onClick={() => setShowContactDialog(true)}>
                Start Free Trial
              </Button>
            </CardContent>
          </Card>
      ...
      <section className="bg-slate-900 text-white py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <Button size="lg" className="bg-white text-slate-900 hover:bg-slate-100" onClick={() => setShowContactDialog(true)}>
            Get Started Today
            <ArrowRight className="ml-2 h-5 w-5" />
          </Button>
        </div>
