...
import { testGA4Connection, trackEvent } from "@/lib/analytics"
...
export function GA4Debug() {
  ...
  const testStartFreeTrial = async () => {
    await trackEvent('click_start_free_trial', {
      event_category: 'cta',
      event_label: 'start_free_trial_debug',
      button_location: 'debug_panel',
      button_text: 'Start Free Trial'
    })
    addTestResult("🧪 Sent 'click_start_free_trial' test event")
  }

  const testRequestDemo = async () => {
    await trackEvent('click_request_demo', {
      event_category: 'cta',
      event_label: 'request_demo_debug',
      button_location: 'debug_panel',
      button_text: 'Request Demo'
    })
    addTestResult("🧪 Sent 'click_request_demo' test event")
  }
